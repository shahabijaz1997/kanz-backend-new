  ...
  },
  {
    ...
    options: {
      schema: [
        ...
        { index: 5, statement: '100% (Full portfolio must be liquid)', is_range: true, lower_limit: 100,
          uper_limit: 100, unit: '%' }
      ]
    }
  },
    ...
    options: {
      schema: [{
        index: 1, statement: 'Less than 1 year', is_range: true, lower_limit: 0, uper_limit: 1, unit: 'year'
               ...
               { index: 5, statement: 'More than 10 years', is_range: true, lower_limit: 10, uper_limit: 0,
                 unit: 'year' }]
    }
  }, {
    step: 5,
